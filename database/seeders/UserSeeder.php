...
class UserSeeder extends Seeder
{
    ...
    {
        $users = [
            ['first_name' => 'Администратор', 'last_name' => '', 'middle_name' => null, 'email' => 'admin@rubikonik.com', 'phone' => '+7 (615) 733 69 15', 'address' => null, 'password' => Hash::make('Admin1234'), 'role' => 'Администратор', 'created_at' => '2024-01-01'],
            ['first_name' => 'Менеджер', 'last_name' => '', 'middle_name' => null, 'email' => 'manager@rubikonik.com', 'phone' => '+7 (615) 733 69 16', 'address' => null, 'password' => Hash::make('Manager123'), 'role' => 'Менеджер', 'created_at' => '2024-01-02'],
            ['first_name' => 'Иван', 'last_name' => 'Петров', 'middle_name' => 'Сергеевич', 'email' => 'ivan@example.com', 'phone' => '+7 (615) 733 69 17', 'address' => 'г. Москва, ул. Ленина, д. 12, кв. 34', 'password' => Hash::make('User1234'), 'role' => 'Пользователь', 'created_at' => '2024-01-03'],
