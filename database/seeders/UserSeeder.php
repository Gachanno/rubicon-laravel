...
class UserSeeder extends Seeder
{
    public function run(): void
    {
        $users = [
            ...
            ['first_name' => 'Менеджер', 'last_name' => '', 'middle_name' => null, 'email' => 'manager', 'phone' => '+7 (615) 733 69 16', 'address' => null, 'password' => Hash::make('Manager123'), 'role' => 'Менеджер', 'created_at' => '2024-01-02'],
